...
const projectsData = [
  {
    ...
    shortDescription: "A machine learning-powered system providing accurate recommendations, featuring a Laravel front-end and a Python back-end.",
    details: [
    ...
    tags: ["Laravel", "PHP", "Machine Learning", "Python", "MySQL", "AJAX", "REST API"],
    github: "https://github.com/srgjo27/ud_anthony",
  },
  {
    title: "DELHUB",
    period: "Jan 2023 - Jun 2024",
    shortDescription: "A mobile app to digitize academic administration for students and supervisors, featuring scheduling, grading, and document uploads.",
    details: [
  ...
  },
  {
    ...
    shortDescription: "A JavaFX desktop application for market management, featuring inventory and sales tracking with a MySQL backend.",
    details: [
...
export default function ProjectsPage() {
  ...
  useGSAP(() => {
    ...
    tl.from('.projects-title', { opacity: 0, x: -30 })
      .from('.project-card', { 
        opacity: 0, 
        y: 40, 
        stagger: 0.2 
  ...
  return (
    <div className="flex-1 space-y-8 p-4 md:p-8 pt-6" ref={main}>
      <div className="flex items-center justify-between space-y-2">
        <h2 className="projects-title text-3xl font-bold tracking-tight font-headline">Projects</h2>
      </div>
            ...
            <Dialog>
              <Card className="flex flex-col h-full overflow-hidden hover:shadow-lg hover:shadow-primary/10">
                <CardHeader className="p-0">
                    <Image src={project.image} alt={project.title} width={600} height={400} className="object-cover" data-ai-hint={project.imageHint} />
                </CardHeader>
