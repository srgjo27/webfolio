...
export function EducationCard({ education, index }: EducationCardProps) {
  return (
    <div className="group relative h-full">
      ...
      >
        <div className="absolute inset-0 bg-linear-to-b from-transparent via-primary/5 to-transparent skew-y-12 translate-y-[-200%] group-hover:animate-scan-fast pointer-events-none" />
        ...
        <div className="flex flex-col md:flex-row gap-6 relative z-10 mb-6">
          <div className="relative shrink-0">
            ...
            <div className="absolute top-1/2 -right-6 w-6 h-px bg-primary/30 hidden md:block group-hover:bg-accent transition-colors duration-500" />
          </div>
        ...
        <div className="h-px w-full bg-linear-to-r from-transparent via-primary/20 to-transparent my-6 group-hover:via-accent/40 transition-all duration-500" />
