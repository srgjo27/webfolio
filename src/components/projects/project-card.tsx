...
export function ProjectCard({ project, onClick }: ProjectCardProps) {
  return (
    ...
    >
      ...
      >
        <div className="absolute inset-0 bg-linear-to-b from-transparent via-primary/5 to-transparent skew-y-12 translate-y-[-200%] group-hover:animate-scan-fast pointer-events-none z-10" />
