        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="h-[2px] w-20 bg-linear-to-r from-primary to-cyan-400 mt-1" />
            </div>
          </div>
      ...
      <CardContent className="relative z-10 space-y-6">
        ...
        <div className="relative mt-6 p-4 border-2 border-primary/20 clip-corner-cut bg-black/20">
          ...
          <div className="relative h-2 bg-card border border-primary/30 overflow-hidden">
              ...
              {[...Array(20)].map((_, i) => (
                <div
                  ...
                  className={`flex-1 border-r border-primary/20 ${
                    i < 16
                      ? "bg-linear-to-t from-primary to-cyan-400"
                      : "bg-transparent"
                  }`}
                  style={{
            ...
            <div className="absolute inset-0 w-full h-full bg-linear-to-r from-transparent via-primary/50 to-transparent animate-pulse" />
          </div>
