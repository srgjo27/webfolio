...
import { PROFILE_INFO, ROLE_TAGS } from "@/constants/home-data";
import { useHome } from "@/hooks/use-home";

export function ProfileCard() {
  const { stats, cardBarcode } = useHome();
      ...
      <CardHeader className="flex flex-row items-start gap-8 relative z-10 pb-6 pt-20">
        ...
        <div className="flex-1 space-y-4">
          <div className="profile-title relative">
            ...
            <div className="absolute -bottom-1 left-0 h-[2px] w-32 bg-linear-to-r from-primary via-cyan-400 to-transparent" />
          </div>
            ...
            {ROLE_TAGS.map((role: string, index: number) => (
              <span
                ...
                className="relative px-3 py-1.5 text-xs font-bold font-mono-cyber 
                             bg-linear-to-r from-primary/20 to-cyan-400/20 
